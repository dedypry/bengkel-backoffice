        ...
        return (
          <div key={groupName} className="group transition-all">
            ...
            <div className="flex items-center justify-between mb-4 px-2">
              ...
              <Checkbox
                classNames={{
                  label: `text-[10px] font-black uppercase ${isSomeGroupSelected || isAllGroupSelected ? "text-danger" : "text-secondary"}`,
                }}
                color="danger"
              ...
              {items.map((item) => {
                ...
                return (
                  <div
                    key={item.id}
                    className={`
                      cursor-pointer p-4 rounded-md border-2 transition-all flex items-start gap-4
                      ${
                        isSelected
                          ? "border-danger shadow-danger-200"
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      <p
                        className={`text-xs font-black uppercase ${isSelected ? "text-danger" : "text-gray-500"}`}
                      >
                        {item.name}
                      </p>
                      <p
                        className={`text-[10px] leading-relaxed font-medium ${isSelected ? "text-danger" : "text-gray-400"}`}
                      >
                        {item.description}
                      </p>
                    </div>
