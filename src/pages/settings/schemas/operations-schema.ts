...
export const operationsSchema = z.object({
  ...
  default_km_increment: z.coerce.number().min(0).optional(),
  default_cash_account_id: z.coerce.number().optional().nullable(),
  default_warehouse_id: z.coerce.number().optional().nullable(),
  pit_count: z.coerce.number().min(0).optional().nullable(),
